        ...
        <div class="col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Informasi Detail sales</h3>
                </div>
                <div class="panel-body">
                    <!--Menampilkan data detail sales-->
                    <?php
                    ...
                    <table class="table table-bordered table-striped table-hover"> 
                        <tr>
                            <td width="200">Kategori</td> <td><?= $data['kategori'] ?></td>
                        </tr>
                        <tr>
						...
						<tr>
                            <td>Penerbit sales</td> <td><?= $data['penerbit'] ?></td>
                        </tr>
						<tr>
                            <td>Penerima sales</td> <td><?= $data['penerima'] ?></td>
                        </tr>
						<tr>
                ...
                <div class="panel-footer">
                    <a href="?page=sales&actions=tampil" class="btn btn-success btn-sm">
